...
struct TimelineView: View {
    ...
    let darkBackground = Color(red: 0.1, green: 0.1, blue: 0.1) // Near black
    let headerBackground = Color(red: 0.12, green: 0.12, blue: 0.12)
    let timelineLineColor = Color(red: 0.25, green: 0.25, blue: 0.25)
    let accentColor = Color(red: 1.0, green: 0.55, blue: 0.55) // Coral/Pink
