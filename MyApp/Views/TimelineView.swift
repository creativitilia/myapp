                ...
                ZStack(alignment: .bottomTrailing) {
                    ScrollView(.vertical) {
                        ZStack(alignment: .topLeading) {
                            ...
                            // C. Current Time Indicator (Red Line)
                            if vm.calendar.isDate(vm.selectedDate, inSameDayAs: Date()) {
                                ...
                                // Center the line precisely on the vertical timeline
                                .offset(x: vm.timeColumnWidth + 10 + 22 - 4, y: currentY - 4)
                    ...
                    Button {
                        ...
                        Image(systemName: "plus")
                            ...
                            .clipShape(Circle())
                            .shadow(color: Color(hex: "#FF8C8C")!.opacity(0.4), radius: 8, y: 4)
                    }
                    .padding(24)
                }
            }
