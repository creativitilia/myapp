...
struct TaskBlockView: View {
    ...
    var body: some View {
        ...
        .frame(height: max(height, 44), alignment: .top) // Ensure tap target is at least icon size
        .contentShape(Rectangle()) // Makes the whole row draggable, not just the text
